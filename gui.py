...
def graphOutput():
    ...
    sizeInput = Entry(graphOptions,bd=0)
    ...
    xMinInput = Entry(graphOptions,bd=0)
    ...
    xMaxInput = Entry(graphOptions,bd=0)
    ...
    yMinInput = Entry(graphOptions,bd=0)
    ...
    xIncInput = Entry(graphOptions,bd=0)
    ...
    yIncInput = Entry(graphOptions,bd=0)
    ...
    numPointInput = Entry(graphOptions,bd=0)
